...
[2/6] Creating Piri node...
✅ Node created with DID: did:key:z6MkhaXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX

[3/6] Registering provider with contract...
⏳ Waiting for registration to be confirmed on-chain...
   Transaction status: pending
   Transaction status: confirmed
✅ Node registered with contract ProviderID: 42

[4/6] Setting up proof set...
...
[5/6] Registering with delegator service...
✅ Successfully registered with delegator service
📥 Requesting proofs from delegator service...
✅ Received proofs from delegator

[6/6] Generating configuration file...
