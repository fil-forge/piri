...
func (t *AggregatorJob) MarshalCBOR(w io.Writer) error {
	if t == nil {
		_, err := w.Write(cbg.CborNull)
		return err
	}
...
func (t *AggregatorJob) UnmarshalCBOR(r io.Reader) (err error) {
	*t = AggregatorJob{}
	...
	if extra > cbg.MaxLength {
		return fmt.Errorf("AggregatorJob: map struct too large (%d)", extra)
	}
...
func (t *ManagerJob) MarshalCBOR(w io.Writer) error {
	if t == nil {
		_, err := w.Write(cbg.CborNull)
		return err
	}
...
func (t *ManagerJob) UnmarshalCBOR(r io.Reader) (err error) {
	*t = ManagerJob{}
	...
	if extra > cbg.MaxLength {
		return fmt.Errorf("ManagerJob: map struct too large (%d)", extra)
	}
...
func (t *CommpJob) MarshalCBOR(w io.Writer) error {
	if t == nil {
		_, err := w.Write(cbg.CborNull)
		return err
	}
...
func (t *CommpJob) UnmarshalCBOR(r io.Reader) (err error) {
	*t = CommpJob{}
	...
	if extra > cbg.MaxLength {
		return fmt.Errorf("CommpJob: map struct too large (%d)", extra)
	}
